...
func PathToScenesFn(ctx context.Context, name string, paths []string, sceneReader models.SceneReader, fn func(ctx context.Context, scene *models.Scene) error) error {
...
func PathToImagesFn(ctx context.Context, name string, paths []string, imageReader models.ImageReader, fn func(ctx context.Context, scene *models.Image) error) error {
	regex := getPathQueryRegex(name)
	organized := false
...
func PathToGalleriesFn(ctx context.Context, name string, paths []string, galleryReader models.GalleryReader, fn func(ctx context.Context, scene *models.Gallery) error) error {
	regex := getPathQueryRegex(name)
	organized := false
