...
func TestImporterPostImport(t *testing.T) {
	...
	db.Studio.On("UpdateImage", testCtx, errAliasID, imageBytes).Return(nil).Once()

	db.Studio.On("UpdateAliases", testCtx, studioID, i.Input.Aliases).Return(nil).Once()
	db.Studio.On("UpdateAliases", testCtx, errImageID, i.Input.Aliases).Return(nil).Maybe()
	db.Studio.On("UpdateAliases", testCtx, errAliasID, i.Input.Aliases).Return(updateTagAliasErr).Once()
