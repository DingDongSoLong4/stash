...
func QueryWithCount(ctx context.Context, qb models.SceneReader, sceneFilter *models.SceneFilterType, findFilter *models.FindFilterType) ([]*models.Scene, int, error) {
...
func Query(ctx context.Context, qb models.SceneReader, sceneFilter *models.SceneFilterType, findFilter *models.FindFilterType) ([]*models.Scene, error) {
...
func CountByStudioID(ctx context.Context, r models.SceneReader, id int, depth *int) (int, error) {
...
func CountByTagID(ctx context.Context, r models.SceneReader, id int, depth *int) (int, error) {
	filter := &models.SceneFilterType{
