...
func (_m *ImageReaderWriter) AddFileID(ctx context.Context, id int, fileID file.ID) error {
...
func (_m *ImageReaderWriter) CountByFileID(ctx context.Context, fileID file.ID) (int, error) {
...
func (_m *ImageReaderWriter) FindByFileID(ctx context.Context, fileID file.ID) ([]*models.Image, error) {
	ret := _m.Called(ctx, fileID)

	var r0 []*models.Image
	if rf, ok := ret.Get(0).(func(context.Context, file.ID) []*models.Image); ok {
		r0 = rf(ctx, fileID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.Image)
...
func (_m *ImageReaderWriter) FindByFingerprints(ctx context.Context, fp []file.Fingerprint) ([]*models.Image, error) {
	ret := _m.Called(ctx, fp)

	var r0 []*models.Image
	if rf, ok := ret.Get(0).(func(context.Context, []file.Fingerprint) []*models.Image); ok {
		r0 = rf(ctx, fp)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.Image)
...
func (_m *ImageReaderWriter) FindByFolderID(ctx context.Context, folderID file.FolderID) ([]*models.Image, error) {
	ret := _m.Called(ctx, folderID)

	var r0 []*models.Image
	if rf, ok := ret.Get(0).(func(context.Context, file.FolderID) []*models.Image); ok {
		r0 = rf(ctx, folderID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*models.Image)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, file.FolderID) error); ok {
		r1 = rf(ctx, folderID)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ImageReaderWriter) FindByZipFileID(ctx context.Context, zipFileID file.ID) ([]*models.Image, error) {
...
func (_m *ImageReaderWriter) GetFiles(ctx context.Context, relatedID int) ([]file.File, error) {
	ret := _m.Called(ctx, relatedID)

	var r0 []file.File
	if rf, ok := ret.Get(0).(func(context.Context, int) []file.File); ok {
		r0 = rf(ctx, relatedID)
	} else {
		if ret.Get(0) != nil {
...
func (_m *ImageReaderWriter) GetManyFileIDs(ctx context.Context, ids []int) ([][]file.ID, error) {
	ret := _m.Called(ctx, ids)
