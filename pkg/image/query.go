...
func Query(ctx context.Context, qb models.ImageReader, imageFilter *models.ImageFilterType, findFilter *models.FindFilterType) ([]*models.Image, error) {
...
func CountByStudioID(ctx context.Context, r models.ImageReader, id int, depth *int) (int, error) {
	filter := &models.ImageFilterType{
...
func CountByTagID(ctx context.Context, r models.ImageReader, id int, depth *int) (int, error) {
	filter := &models.ImageFilterType{
...
func FindGalleryCover(ctx context.Context, r models.ImageReader, galleryID int, galleryCoverRegex string) (*models.Image, error) {
...
func findGalleryCover(ctx context.Context, r models.ImageReader, galleryID int, useCoverJpg bool, galleryCoverRegex string) (*models.Image, error) {
