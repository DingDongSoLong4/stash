...
func Destroy(ctx context.Context, destroyer models.FileReaderWriter, f models.File, fileDeleter *Deleter, deleteFile bool) error {
...
type ZipDestroyer struct {
	FileDestroyer   models.FileReaderWriter
	FolderDestroyer models.FolderReaderWriter
}
