...
func createScenes(ctx context.Context, sqb models.SceneReaderWriter, folderStore models.FolderReaderWriter, fileStore models.FileReaderWriter) error {
	// create the scenes
...
func createSceneFile(ctx context.Context, name string, folderStore models.FolderReaderWriter, fileStore models.FileReaderWriter) (*models.VideoFile, error) {
...
func getOrCreateFolder(ctx context.Context, folderStore models.FolderReaderWriter, folderPath string) (*models.Folder, error) {
...
func createImages(ctx context.Context, w models.ImageReaderWriter, folderStore models.FolderReaderWriter, fileStore models.FileReaderWriter) error {
	// create the images
...
func createImageFile(ctx context.Context, name string, folderStore models.FolderReaderWriter, fileStore models.FileReaderWriter) (*models.ImageFile, error) {
	folderPath := filepath.Dir(name)
	basename := filepath.Base(name)
...
func createGalleries(ctx context.Context, w models.GalleryReaderWriter, folderStore models.FolderReaderWriter, fileStore models.FileReaderWriter) error {
...
func createGalleryFile(ctx context.Context, name string, folderStore models.FolderReaderWriter, fileStore models.FileReaderWriter) (*models.BaseFile, error) {
	folderPath := filepath.Dir(name)
	basename := filepath.Base(name)
