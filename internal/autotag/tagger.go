...
func (t *tagger) tagScenes(ctx context.Context, paths []string, sceneReader models.SceneReader, addFunc addSceneLinkFunc) error {
...
func (t *tagger) tagImages(ctx context.Context, paths []string, imageReader models.ImageReader, addFunc addImageLinkFunc) error {
...
func (t *tagger) tagGalleries(ctx context.Context, paths []string, galleryReader models.GalleryReader, addFunc addGalleryLinkFunc) error {
