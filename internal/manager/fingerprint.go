...
func (c *fingerprintCalculator) calculateOshash(f *models.BaseFile, o models.FileOpener) (*models.Fingerprint, error) {
	r, err := o.Open()
	if err != nil {
...
func (c *fingerprintCalculator) calculateMD5(o models.FileOpener) (*models.Fingerprint, error) {
	r, err := o.Open()
	if err != nil {
		return nil, fmt.Errorf("opening file: %w", err)
	}
...
func (c *fingerprintCalculator) CalculateFingerprints(f *models.BaseFile, o models.FileOpener, useExisting bool) ([]models.Fingerprint, error) {
	var ret []models.Fingerprint
	calculateMD5 := true

	if c.ExtensionMatcher.UseAsVideo(f.Path) {
		var (
